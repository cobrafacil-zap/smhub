    ...
    <div className="min-h-screen bg-bg text-slate-100">
      <div className="max-w-4xl mx-auto px-4 lg:px-6 py-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <a
            href="/"
            className="text-sm text-slate-500 hover:text-royal-300"
          >
            ← Voltar
          </a>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
          ...
          <div className="md:col-span-3">
            <Card>
              ...
              {isRenovacao && (
                <div className="mt-4 p-3 rounded-lg bg-royal-500/5 border border-royal-500/20 text-xs text-slate-400">
                  💳 Pagamento processado pelo <strong className="text-royal-300">Mercado Pago</strong>. Aceitamos cartão de
                  crédito, PIX e boleto.
                </div>
              )}
              {!isRenovacao && (
                <div className="mt-4 p-3 rounded-lg bg-success-500/5 border border-success-500/20 text-xs text-slate-400">
                  ✅ <strong className="text-success-400">7 dias grátis</strong> — nenhuma cobrança agora. Você só paga após o
