...
//
// A action altera APENAS o status. O prazo é independente: ao mover para
// "entregue", a data definida antes é preservada (não sobrescrevemos com a
// data de hoje). Mover de volta para outro status também não mexe no prazo.
// ============================================================================
