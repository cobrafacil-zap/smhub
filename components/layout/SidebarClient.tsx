...
export function SidebarClient({ userName }: { userName: string }) {
      ...
      <div className="px-5 py-5 border-b border-border">
        <Link href="/cliente" className="flex items-center gap-3">
          ...
          <div className="leading-tight min-w-0">
            <p className="font-semibold text-sm text-white">Portal do Cliente</p>
            <p className="text-[11px] text-slate-500">SM Hub</p>
          </div>
        </Link>
      </div>
